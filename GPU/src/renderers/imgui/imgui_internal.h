...
struct IMGUI_API ImGuiComboPreviewData
{
    ...
    ImGuiComboPreviewData(void) { memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMenuColumns
{
    ...
    ImGuiMenuColumns(void) { memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiErrorRecoveryState
{
    ...
    ImGuiErrorRecoveryState(void) { memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiInputEvent
{
    ...
    ImGuiInputEvent(void) { memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiTypingSelectState
{
    ...
    ImGuiTypingSelectState(void) { memset(this, 0, sizeof(*this)); }
...
struct ImGuiOldColumnData
{
    ...
    ImGuiOldColumnData(void) { memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMultiSelectState
{
    ...
    ImGuiMultiSelectState(void) { Window = NULL; ID = 0; LastFrameActive = LastSelectionSize = 0; RangeSelected = NavIdSelected = -1; RangeSrcItem = NavIdItem = ImGuiSelectionUserData_Invalid; }
};
...
struct ImGuiDebugAllocInfo
{
    ...
    ImGuiDebugAllocInfo(void) { memset(this, 0, sizeof(*this)); }
};
...
//#endif
    ...
    // Basic Accessors
    inline ImGuiItemStatusFlags GetItemStatusFlags(void) { ImGuiContext& g = *GImGui; return g.LastItemData.StatusFlags; }
    ...
    inline ImGuiID          GetCurrentFocusScope(void) { ImGuiContext& g = *GImGui; return g.CurrentFocusScopeId; }   // Focus scope we are outputting into, set by PushFocusScope()
    ...
    // Tables: Internals
    inline    ImGuiTable*   GetCurrentTable(void) { ImGuiContext& g = *GImGui; return g.CurrentTable; }
    ...
    // Tab Bars
    inline    ImGuiTabBar*  GetCurrentTabBar(void) { ImGuiContext& g = *GImGui; return g.CurrentTabBar; }
